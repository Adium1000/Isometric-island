![intro](.github/Banners/thumb.png)
...
![2. Hotbar or Blocks](.github/Guide/2.png)

![Hotbar Image](.github/Guide/hotbar.png)
...
![3. Island and Block Placement](.github/Guide/3.png)

![Hotbar Image](.github/Guide/Island.png)
...
![4. Island Shaping](.github/Guide/4.png)
 
![Island shaped like a circle image](.github/Guide/model%20island.png)
...
![The Hotbar eraser item](.github/Guide/hotbareraser.png)
...
![5. MultiLayer Objects](.github/Guide/5.png)

![im](.github/Guide/intro.png)
...
![im](.github/Guide/invent.png)

![6. Details & Shadows](.github/Guide/6.png)

- This game includes island and block shadows.
- Also, the trees sometimes drop leaves in 3 different styles.


![im](.github/Banners/leaf.png)

![7. Background Music](.github/Guide/7.png)
...
![spotifychill](.github/Guide/music.png)


![bgmusicbutton](.github/Guide/rmusic.png)

![8. Island Float](.github/Guide/8.png)
...
![flo](.github/Guide/float-settings.png)

![float](.github/Guide/flo.png)

![9. Cursors](.github/Guide/9.png)
...
![Aboutcursors](.github/Guide/about_cursors.png)

![10. Keyboard Shortcuts](.github/Guide/0.png)
...
![MiniMap](.github/Guide/minimap.png)


![12. Undo and Redo](.github/Guide/02.png)
...
![13. File Menu](.github/Guide/03.png)
...
![File menu ](.github/Guide/FileMenu.png)
...
![Fun menu](<.github/Guide/fun menu.png>)

- Generate random islands.
- Island as an emoji 

![Island as an emoji](<.github/Guide/island as an emoji.png>)
...
![explorer](.github/Guide/c_map2.png)

Map publisher

![publish](.github/Guide/c_map.png)

7. Embed Map
- Do you want to show off your map on a website? , we got u!
- Just Implement it in an IFRAME :D

![EmbedIFrameNow!](.github/Guide/embed.png)

8. Island Analytics
- this option lets you see how manny blocks you used building your island

![analitics](.github/Guide/analitics.png)


![Mouse actions](.github/Guide/04.png)
...
![GRB](.github/Guide/grb.png)


![fill](.github/Guide/05.png)
...
![Button](.github/Guide/G!.png)

- After you click on the button, this popup will open.

![fill](.github/Guide/fill.png)
...
![apk1](.github/Guide/apk1.jpg)

- Click on the file and choose package installer.

![apk2](.github/Guide/apk2.jpg)

- Click on Install.

![apk3](.github/Guide/apk3.jpg)

- If Play Protect pops up, click on More options -> Install without verification.

![apk4](.github/Guide/playtrash.jpg)

And done!


![18. QR code save](.github/Guide/08.png)

- You can share small islands by QR codes via File menu -> QR code button.

![QR](.github/Guide/qr.png)

- Then you can scan it using your phone and keep it safe :3

![SPa56](.github/Guide/a56scan.png)


![19. Settings Menu](.github/Guide/09.png)

![SettingsMenu](.github/Guide/settings_menu.png)
...
![pointer](.github/Guide/po.png)

9. Visual or Graphic settings
- Includes a bunch of sliders for shadows and more.

![go](.github/Guide/go.png)


![removeisland](.github/Guide/Islandremove.png)


![delete popup](.github/Guide/delete.png)

- This menu makes sure you don't accidentally press the delete island button :)

![Search](.github/Guide/search.png)

![SearchMenuPopup](.github/Guide/searchmenu.png)

- Search menu is a menu where you can easily search for blocks by name or by scrolling.

![22.Random island/Mountain menu](.github/Guide/22.png)

 - This menu lets you choose how the randomly generated island will look like.
 
 ![ISLAND_RANDON](.github/Guide/IRG.png)

 ![Mountain_Random](.github/Guide/MGEN.png)


![Gameblocks](.github/Guide/blck.png)
...
![Radial](.github/Guide/radial.png)

![mirrror](.github/Guide/mirror.png)

- Mirror popup contains options for mirroring the brush

![Brush](.github/Guide/bs.png)

- Brush settings contains options about the brush tickness

![Achivements](.github/Guide/achivements_banner.png)

Achivements are a fun way to discover new things about this game :3
You can acces it via the file menu

![Achivements windwow](.github/Guide/achivements.png)

### Warning!
![WarnBanner](.github/Banners/warningb.png)
...
### Issues
![Issues Banner](.github/Banners/Issues.png)

- Sometimes zoom can break the island canvas for unknown reasons.

### (BETA) Meaning
![beta](.github/Banners/betab.png)
...
![software banner](.github/Banners/softwareb.png)
...
# Future functions
![todolist banner](.github/Banners/todolist.png)
...
![scratch_dont_use_scratch](.github/Guide/scratchstorry.png)
...
# Credits
![credits-logo](.github/Banners/creditsb.png)
